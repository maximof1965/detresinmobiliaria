...
import { OPERACIONES, TIPOS } from '@/lib/labels';
...
export default function SearchBar() {
  ...
  return (
    <form
      onSubmit={submit}
      className="grid w-full gap-3 rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)]/95 p-4 shadow-xl backdrop-blur sm:grid-cols-2 lg:grid-cols-[1fr_1fr_2fr_auto]"
    >
      <select
        value={operacion}
