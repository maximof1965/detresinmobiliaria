...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      href={whatsappUrl(`Hola ${siteConfig.name}, estoy interesado en sus propiedades.`)}
      target="_blank"
      rel="noreferrer"
